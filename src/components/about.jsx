...
export const About = () => {
    return (
        <>
            <div className="slide-item overlay about-hero-section">
            <div class="container">
    ...
    <div class="site-section">
        ...
        <div class="row">
            ...
            <div class="team text-center">
                <img src="/theme/images/staff_1.jpg" alt="" class="img-fluid" />
                <h3>Jean Smith</h3>
            ...
            <div class="col-lg-3">
            <div class="team text-center">
                <img src="/theme/images/staff_2.jpg" alt="" class="img-fluid" />
                <h3>Myla Anderson</h3>
                <span class="position d-block">Caregiver</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. At, praesentium?</p>
            </div>
            ...
            <div class="col-lg-3">
            <div class="team text-center">
                <img src="/theme/images/staff_3.jpg" alt="" class="img-fluid" />
                <h3>Cathy Jackson</h3>
                <span class="position d-block">Caregiver</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. At, praesentium?</p>
            </div>
            ...
            <div class="col-lg-3">
            <div class="team text-center">
                <img src="/theme/images/staff_4.jpg" alt="" class="img-fluid" />
                <h3>Mellissa Gold</h3>
                <span class="position d-block">Caregiver</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. At, praesentium?</p>
            </div>
